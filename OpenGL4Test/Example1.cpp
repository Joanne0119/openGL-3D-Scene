...
void loadScene(void)
{
...
#ifdef ATTENUATION
    g_light.setIntensity(12.0f);
    g_light.setAttenuation(1.0f, 0.25f, 0.25f);
#endif
    ...
    g_teapot.setRotate(40, glm::vec3(0, 1, 0));
...
int main() {
    ...
    GLFWwindow* window = glfwCreateWindow(SCREEN_WIDTH, SCREEN_HEIGHT, "OpenGL_4 Example 1 Point(onmi) light", nullptr, nullptr);
    if (!window) {
