...
void loadScene(void)
{
    ...
    g_bottle.setPos(glm::vec3(4.5f, 0.0005f, 4.5f));
    ...
    g_teapot.setPos(glm::vec3(4.0f, 0.0005f, -4.0f));
    g_teapot.setMaterial(g_matWaterRed);
    
    g_sphere.setupVertexAttributes();
    g_sphere.setShaderID(g_shadingProg, 3);
    g_sphere.setScale(glm::vec3(0.5f, 0.5f, 0.5f));
    g_sphere.setPos(glm::vec3(0.0f, 1.5f, 0.0f));
    ...
    g_tknot.setPos(glm::vec3(-3.0f, 0.5f, 3.0f));
...
void genMaterial()
{
    ...
    //g_matWaterGreen.setDiffuse(glm::vec4(0.540f, 0.840f, 0.640f, 1.0f)); // Example 3
    //g_matWaterGreen.setSpecular(glm::vec4(0.40f, 0.40f, 0.40f, 1.0f));  // Example 3
